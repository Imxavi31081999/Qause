...
@Component({
  selector: 'app-desktop-active-single',
  templateUrl: './desktop-active-single.component.html',
  styleUrls: ['./desktop-active-single.component.scss']
})
export class DesktopActiveSingleComponent implements OnInit {
  gigId = "629a3294dba8674f0b2e94ad";
  ...
  docSubmit() {
    ...
    if (this.firstFile && this.secondFile && this.thirdFile) {
      ...
      const upload$ = this.http
        .post(`${environment.prodUrl}/gig/629a3294dba8674f0b2e94ad/images`, formData,)
