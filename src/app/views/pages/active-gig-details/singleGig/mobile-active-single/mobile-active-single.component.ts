...
@Component({
  selector: "app-mobile-active-single",
  templateUrl: "./mobile-active-single.component.html",
  styleUrls: ["./mobile-active-single.component.scss"],
})
export class MobileActiveSingleComponent implements OnInit {
