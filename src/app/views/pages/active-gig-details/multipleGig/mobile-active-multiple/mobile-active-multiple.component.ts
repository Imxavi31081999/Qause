...
@Component({
  selector: 'app-mobile-active-multiple',
  templateUrl: './mobile-active-multiple.component.html',
  styleUrls: ['./mobile-active-multiple.component.scss']
})
export class MobileActiveMultipleComponent implements OnInit {
  ...
  constructor(private location:Location,
    public gigDetailsService: GigDetailsService, private http:HttpClient,
